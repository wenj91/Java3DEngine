...
/*
     ...
     * @return
     */
	int cullObject4D(Object4D o, Camera4D c, int cullFlags) { // �޳�����
	 ...
	 * @param c
     */
	public static void removeBackfacesObject4D(Object4D o, Camera4D c) { // ���屳������
		// �д����
		if(null != o){
			...
			for(Iterator<Poly4D> it=pL.iterator(); it.hasNext(); ){
				...
				Vector4D vd = vn.vector4DCross(vv);//�������
